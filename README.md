...
<p align="center">
  <img src="https://img.shields.io/badge/C++🧠-Low%20Level-blue?style=for-the-badge&logo=c%2B%2B" />
...
---
# ARDUINO COM RUST: 
- [README PROJETO ARDUINO COM RUST](https://github.com/Alice-grandel/PROJETO.ARDUINO/blob/c++/README.md)
...
- [Repositório oficial Arduino GitHub](https://github.com/arduino)
...
- Estruturas básicas com `digitalWrite`, `pinMode`, `delay`, `Serial.begin`
...
- 💡 LED piscando com C++
- 🔌 Comunicação serial com `Serial Monitor`
- ⚙️ Manipulação de registradores e portas
- 🔧 Setup funcional com C++ e Arduino
...
- 🧠 Controle de sensores simples com C++
